...
CREATE TABLE `user` (
  ...
  `u_street` varchar(64) DEFAULT NULL,
  `u_city` varchar(32) DEFAULT NULL,
  `u_state` varchar(32) DEFAULT NULL,
  `u_zip` int DEFAULT NULL,
  `u_country` varchar(32) DEFAULT NULL,
  `u_substatus` tinyint(1) DEFAULT NULL,
  PRIMARY KEY (`u_ID`)
