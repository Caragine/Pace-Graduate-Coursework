...
val x = 5 // immutable variable (cannot be changed)

var y = 6 // mutable value (can be changed)

//x = 10 // THROWS ERROR BC IMMUTABLE
...
val setLetters = setOf("a", "b", "c")                 // Set<String> (Set is unordered and does not allow duplicate values)
...
// MAP LIST FUNCTION -> APPLY FUNCTION ON EVERY ELEMENT OF LIST
// REDUCE LIST FUNCTION -> APPLY THE FUNCTION TO REDUCE THE LIST TO ONE RESULT
